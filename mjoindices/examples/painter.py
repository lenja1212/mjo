...
def drawPc(pc_text_file: Path, pc_png_file: Path, inverse1 = 0, inverse2 = 0)
    pc1 = []
    pc2 = []
    ...
    rotated_data = rotate_vector(form_data(feb_arr_pc1, feb_arr_pc2), -10)
    ...
    rotated_data = rotate_vector(form_data(mar_arr_pc1, mar_arr_pc2), -10)
    ...
    # plt.savefig('./PCs-eraOlrAbs-U_2015-F30.png')

    plt.savefig(pc_png_file)
