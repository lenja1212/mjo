...
#the string below worked fine  
#olr_data_filename = Path(os.path.abspath('')).parents[0] / "tests" / "testdata" / "era5-mtnlwrf-slavgrid_cmp.nc"
...
# The EOFs
eofnpzfile = Path(os.path.abspath('')) / "example_data" / "EOFs-1year-testOldData_1915.npz"
# The PCs
pctxtfile = Path(os.path.abspath('')) / "example_data" / "PCs-1year-testOldData_1915.txt"
# Directory in which the figures are saved.
fig_dir = Path(os.path.abspath('')) / "example_data" / "omi_recalc_example_plots-1year-testOldData_1915"
...
shorter_olr = olr.restrict_time_coverage(raw_olr, np.datetime64('2015-01-01'), np.datetime64('2015-12-31'))
...
print("Diagnosis plot of the loaded OLR data")
# Diagnosis plot of the loaded OLR data
fig = olr.plot_olr_map_for_date(interpolated_olr, np.datetime64("2015-01-01")) #("1991-01-01") ("2010-01-01"))
fig.show()
fig.savefig(fig_dir / "OLR_map-1year-eraOldData_2015.png")
...
eoftxtfile1 = Path(os.path.abspath('')) / "example_data" / "EOFs-1year-testOldData_2015"
eofs.save_all_eofs_to_dir(eoftxtfile1)
...
fig.show()
fig.savefig(fig_dir / "EOFs_CorrelationWithOriginal-1year-testOldData_1915.png")
...
fig.show()
fig.savefig(fig_dir / "EOFs_ExplainedVariance-1year-testOldData_1915.png")
...
fig.show()
fig.savefig(fig_dir / "EOF_Sample-1year-testOldData_1915.png")
...
fig.show()
fig.savefig(fig_dir / "EOF_SampleComparison-1year-testOldData_1915.png")
...
fig.show()
fig.savefig(fig_dir / "EOF_SampleExplainedVariance-1year-testOldData_1915.png")
...
#olr = olr.load_noaa_interpolated_olr(olr_data_filename) # worked fine for test data
...
fig.savefig(fig_dir / "PCs_TimeSeries-1year-testOldData_2015.png")
